...
public class UserController {
    ...
    @Transactional
    public Response createAdmin(@Valid @Parameter(description = "Логин и пароль нового администратора",
            required = true) UserCreateDto dto) {
    ...
    @Path("/login")
    @Produces(MediaType.APPLICATION_JSON)
    public UserRoleDto login(@Valid @Parameter(description = "Вход для администратора", required = true) UserLoginDto dto) {
